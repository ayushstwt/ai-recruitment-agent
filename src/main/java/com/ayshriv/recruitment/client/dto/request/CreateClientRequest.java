...
/**
 * Request payload for creating a client company.
 *
 * <p>The tenant is never part of the payload: the organization is resolved
 * from the authenticated API key via the security context. The client code is
 * generated by the backend and must never be supplied by the caller.</p>
 */
@Getter
@Setter
@NoArgsConstructor
