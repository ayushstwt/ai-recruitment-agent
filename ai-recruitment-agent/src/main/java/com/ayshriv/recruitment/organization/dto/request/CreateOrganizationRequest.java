...
/**
 * Request payload for provisioning a new organization.
 *
 * <p>Creation is a controlled provisioning operation (the organization
 * does not exist yet and therefore cannot authenticate with one of its own
 * API keys). It must never carry a tenant identifier.</p>
 */
@Getter
@Setter
@NoArgsConstructor
